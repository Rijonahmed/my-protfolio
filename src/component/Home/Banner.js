      ...
      <div class="hero min-h-screen ">
        <div class="hero-content flex-col lg:flex-row">
          ...
          >
            ...
            <a className='bg-orange-600 p-3 rounded-2xl text-white font-bold text-center' href="https://drive.google.com/file/d/1jP_MTWgPW32AM_teIBYb2djO5CuqTB47/view" target="_blank" rel="noopener noreferrer">Downlode Resume</a>
          </motion.div>
        </div>
      </div>
    </div>
